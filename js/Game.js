...
class Game extends UI {
    ...
    #newGame(
        ...
        this.#buttons.reset.changeEmetion('neutral');
        ...
        if (!isWin) {
            ...
            this.#buttons.reset.changeEmetion('negative');
            this.#modal.setText();
        ...
        this.#buttons.reset.changeEmetion('positive');
        this.#modal.setText();
        this.#modal.toggleModal();
    }
    #handleElements() {
    ...
    #addButtonsEventListener() {
        ...
        this.#buttons.easy.addEventListener(`click`, () => { this.#handleNewwGameClick(this.#config.easy.rows, this.#config.easy.cols, this.#config.easy.mines) });
        this.#buttons.normal.addEventListener(`click`, () => { this.#handleNewwGameClick(this.#config.normal.rows, this.#config.normal.cols, this.#config.normal.mines) });
        this.#buttons.expert.addEventListener(`click`, () => { this.#handleNewwGameClick(this.#config.expert.rows, this.#config.expert.cols, this.#config.expert.mines) });
        this.#buttons.reset.element.addEventListener(`click`, () => { this.#handleNewwGameClick() });
    }
    #handleNewwGameClick(rows = this.#numberOfRows, cols = this.#numberOfCols, mines = this.#numberOfMines) {
